    ...
    for image_file in os.listdir("test"):
        ...
        if predictions == []:
            ...
            for items in predictions:
                #print("Tuple = ",items)
                tup = items[0]
                #print('Name in  tuple=',tup)
                predicted_name.append(tup)
                #print("Name list = ",predicted_name)
            #tup = predictions[0]
            #print(tup)
            #predicted_name = []
            #predicted_name.append(tup[0])
            predicted_name  = list(dict.fromkeys(predicted_name))

            #name_set = set(tup)
            #print('hello '+str(predicted_name[0]))
            #name_set.add(tup)
            #for names in name_set:
                #print("Hello {}".format(name_set)
        #print("predicted name = ",predicted_name)
            #print(tup[0])
        # Print results on the c[onsole
        #for name, (top, right, bottom, left) in predictions:
